...
async function seed() {
  ...
  // Helper function to get dates from the last 7 days
  ...
  // Create sample orders with dates in the last 7 days
  const orders = [
    {
      ...
      createdAt: getRecentDate(6),  // 6 days ago
    },
    {
      type: 'sale', status: 'completed', counterparty: 'TechWorld Inc',
      items: [
        { product: products[6]._id, productName: products[6].name, sku: products[6].sku, quantity: 3, unitPrice: products[6].sellingPrice, subtotal: 3 * products[6].sellingPrice },
        { product: products[8]._id, productName: products[8].name, sku: products[8].sku, quantity: 10, unitPrice: products[8].sellingPrice, subtotal: 10 * products[8].sellingPrice },
      ],
    ...
    },
    {
      ...
      createdAt: getRecentDate(4),  // 4 days ago
    },
    {
      type: 'sale', status: 'completed', counterparty: 'StartupHub',
      items: [
        { product: products[9]._id, productName: products[9].name, sku: products[9].sku, quantity: 2, unitPrice: products[9].sellingPrice, subtotal: 2 * products[9].sellingPrice },
      ...
      createdAt: getRecentDate(3),  // 3 days ago
    },
    {
      type: 'sale', status: 'completed', counterparty: 'GlobalTech Ltd',
      items: [
        { product: products[3]._id, productName: products[3].name, sku: products[3].sku, quantity: 1, unitPrice: products[3].sellingPrice, subtotal: 1 * products[3].sellingPrice },
        { product: products[15]._id, productName: products[15].name, sku: products[15].sku, quantity: 5, unitPrice: products[15].sellingPrice, subtotal: 5 * products[15].sellingPrice },
      ],
      createdAt: getRecentDate(2),  // 2 days ago
    },
    {
      type: 'sale', status: 'completed', counterparty: 'EduCenter',
      items: [
        { product: products[11]._id, productName: products[11].name, sku: products[11].sku, quantity: 30, unitPrice: products[11].sellingPrice, subtotal: 30 * products[11].sellingPrice },
        { product: products[5]._id, productName: products[5].name, sku: products[5].sku, quantity: 100, unitPrice: products[5].sellingPrice, subtotal: 100 * products[5].sellingPrice },
      ],
      createdAt: getRecentDate(1),  // Yesterday
    },
    {
      type: 'sale', status: 'pending', counterparty: 'InnovateCo',
      items: [
        { product: products[7]._id, productName: products[7].name, sku: products[7].sku, quantity: 2, unitPrice: products[7].sellingPrice, subtotal: 2 * products[7].sellingPrice },
        { product: products[24]._id, productName: products[24].name, sku: products[24].sku, quantity: 1, unitPrice: products[24].sellingPrice, subtotal: 1 * products[24].sellingPrice },
      ],
      createdAt: getRecentDate(0),  // Today
    },
  ];
  ...
  for (const o of orders) {
    ...
    await Order.create({ 
      ...
      total: sub, 
      createdBy: admin._id,
      createdAt: o.createdAt,  // Set the created date
      updatedAt: o.createdAt   // Match updated date
    });
  }
